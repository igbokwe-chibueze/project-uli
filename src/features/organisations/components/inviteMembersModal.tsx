// src/features/organisations/components/inviteMembersModal.tsx

'use client';

import { useEffect, useState, useTransition } from "react";
import { CheckIcon, CopyIcon, LoaderCircleIcon, RefreshCcw, SendIcon, UsersIcon } from "lucide-react";
...
export const InviteMembersModal = ({ open, onOpenChange, organisationId, roleData }: MembersClientProps) => {
    ...
    }, [open, organisationId, loadedOnce]);
